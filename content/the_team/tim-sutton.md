...
departmentIcon: "fa-crown"
weight: 1
draft: false
image: "/img/team/tim-sutton.jpg"
location: "Alentejo, Portugal"
country: "Portugal"
coordinates: "38.5667, -7.9000"
github: "timlinux"
email: "tim@kartoza.com"
education:
  - degree: "Master's in GIS and Environmental Studies"
skills:
  - "QGIS"
  - "Python"
  - "Open Source GIS"
  ...
  - "Environmental GIS"
achievements:
  - "QGIS Perpetual Honorary PSC Member (2018)"
  - "Co-founded Kartoza (2014)"
  - "Founded Linfiniti (2008)"
  - "OSGeo Charter Member"
bio: "Perpetual Honorary QGIS PSC Member who co-founded Kartoza in 2014. Focuses on humanitarian and environmental projects using open source geospatial technology."
...
Here is what Chat-GPT has to say about Tim: "Tim Sutton is a notable contributor to QGIS, an open-source geographic information system. His extensive contributions include leadership roles and technical enhancements that significantly impact the software's development. Sutton's prior work spans diverse areas, from core functionalities to plugins, fostering QGIS's growth into a versatile and powerful tool. His commitment to the community is evident through advocacy, mentorship, and fostering collaboration. Sutton's efforts have played a pivotal role in QGIS's evolution, making it an influential platform in the geospatial domain. His dedication highlights the collaborative spirit driving the success and continuous improvement of QGIS as a robust GIS solution."

His focus on humanitarian, social upliftment, and environmental projects reflects Kartoza's core mission of using technology for positive impact. Tim believes that open source software and open data policies are essential for creating a more equitable and sustainable world.

When not coding or strategizing, Tim can be found exploring the beautiful landscapes of Portugal, where he now resides, always thinking about how geospatial technology can make the world a better place.
