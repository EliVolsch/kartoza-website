---
title: "EnergyAccess Explorer Kenya"
description: "An open-source platform integrating electricity and clean cooking planning for Kenya's 54 million residents."
thumbnail: "/img/portfolio/energy-access-kenya.png"
tags:
  - Energy
  - Web Platform
  - Kenya
client: "Clean Cooking Alliance / World Resources Institute"
date: 2020-08-01
endDate: 2023-12-31
services:
  - Development
...
{{< block
    title="EnergyAccess Explorer Kenya"
    subtitle="Integrated energy planning for electricity and clean cooking"
    class="is-primary"
    sub-block-side="bottom"
>}}
Supporting SDG7 through robust, data-driven energy planning for Kenya.
{{< /block >}}
...
1. Promoting holistic approaches toward SDG7
2. Supporting federal-level strategic planning and policy-making
3. Enabling informed, region-specific investments and decisions
4. Functioning as a data repository for location-specific information
5. Facilitating nationwide coordination in clean cooking and electricity sectors

## Partners

- **Clean Cooking Alliance** (Thought Leader/Coordinator)
- **World Resources Institute** (Technical Advisor)
- **KTH Division of Energy Systems** (Technical Partner)
- **Nepal Open University** (Local Partner)

## Technology

- OnStove tool
- OnSSET electrification model
- Energy Access Explorer (EAE)
- Clean Cooking Explorer (CCE)
